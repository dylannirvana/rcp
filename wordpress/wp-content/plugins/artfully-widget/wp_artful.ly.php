...
add_shortcode('artevent', 'art_event_data');
function art_event_data($atts) {
    extract(shortcode_atts(array(
                'id' => '',
                    ), $atts));
    wp_enqueue_script( 'artfully_event', NME_PLUGIN_URL.'/js/artfully-event.js', false, false, true);
    wp_localize_script( 'artfully_event', 'artfully_event_vars', array('eventId' => $id) );
    return '<div id="artfully-event"></div>';
}

add_shortcode('artevent2', 'art_event_data2');
function art_event_data2($atts) {
    extract(shortcode_atts(array(
                'id' => '',
                    ), $atts));
    wp_enqueue_script( 'artfully_event', NME_PLUGIN_URL.'/js/artfully-event.js', false, false, true);
    wp_localize_script( 'artfully_event', 'artfully_event_vars2', array('eventId' => $id) );
    return '<div id="artfully-event2"></div>';
}

add_shortcode('artevent3', 'art_event_data3');
function art_event_data3($atts) {
    extract(shortcode_atts(array(
                'id' => '',
                    ), $atts));
    wp_enqueue_script( 'artfully_event', NME_PLUGIN_URL.'/js/artfully-event.js', false, false, true);
    wp_localize_script( 'artfully_event', 'artfully_event_vars3', array('eventId' => $id) );
    return '<div id="artfully-event3"></div>';
}

add_shortcode('artevent4', 'art_event_data4');
function art_event_data4($atts) {
    extract(shortcode_atts(array(
                'id' => '',
                    ), $atts));
    wp_enqueue_script( 'artfully_event', NME_PLUGIN_URL.'/js/artfully-event.js', false, false, true);
    wp_localize_script( 'artfully_event', 'artfully_event_vars4', array('eventId' => $id) );
    return '<div id="artfully-event4"></div>';
}

add_shortcode('artevent5', 'art_event_data5');
function art_event_data5($atts) {
    extract(shortcode_atts(array(
                'id' => '',
                    ), $atts));
    wp_enqueue_script( 'artfully_event', NME_PLUGIN_URL.'/js/artfully-event.js', false, false, true);
    wp_localize_script( 'artfully_event', 'artfully_event_vars5', array('eventId' => $id) );
    return '<div id="artfully-event5"></div>';
}
...
function art_donation_data($atts) {
    ...
    return '<div id="artfully-donation"></div>';
}
