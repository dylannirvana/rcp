    ...
    <div class="container">
      <div class="navbar-header">
        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#collapse">
          ...
          <a class="navbar-brand" href="#featured"><h1> Ritz Chamber <span class="subhead"><img src="/images/icons/rhombus.png">Players<img src="/images/icons/rhombus.png"> </span></h1></a>
      </div><!-- navbar-header -->
...
<!-- 1.2 Carousel  -->
  <div class="carousel fade" data-ride="carousel" id="featured">
    ...
    <div class="carousel-inner fullheight">
      <div class="item"><img src="images/bio/harpsichord.jpg" alt="Harpsichord"></div>
      <div class="item"><img src="images/bio/singer.jpg" alt="Singer"></div>
      <div class="item"><img src="images/bio/violin.jpg" alt="Violin"></div>
      <div class="item"><img src="images/bio/Concert-1.jpg" alt="Concert"></div>
      <div class="item"><img src="images/bio/Concert-4.jpg" alt="Concert"></div>
    </div><!-- carousel-inner -->
...
<!-- 2. MISSION   -->
<!- REPLACE BOOTSTRAP LAYOUT WITH SUSY ->
    ...
    <!-- <div class="content container">  -->
     ...
     <!--  <article class="players halfheight" id="annHobson">
      ...
      <article class="players halfheight">
        <img src="images/players/annHobson.jpg">
        <div class="content">
          <h2>Ann Hobson guitar</h2>
          <p>Our hotel boasts wireless Internet in every common room, and guest room, including the dining area and lobby. And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art meeting room with video projectors, high definition video screens, and advanced sound technology.</p>
        </div>
 ...
 <article class="players halfheight">
        <img src="images/players/alisonBuchanan.jpg">
        <div class="content">
          <h2>Ann Hobson </h2>
          <p>Our hotel boasts wireless Internet in every common room, and guest room, including the dining area and lobby. And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art meeting room with video projectors, high definition video screens, and advanced sound technology.</p>
        </div>
       ...
       <article class="players halfheight">
        <img src="images/players/davidBerry.jpg">
        <div class="content">
          <h2>David Berry</h2>
          <p>Our hotel boasts wireless Internet in every common room, and guest room, including the dining area and lobby. And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art meeting room with video projectors, high definition video screens, and advanced sound technology.</p>
        </div>
 ...
 <article class="players halfheight">
        <img src="images/players/georgeTaylor.jpg">
        <div class="content">
          <h2>George Taylor</h2>
          <p>Our hotel boasts wireless Internet in every common room, and guest room, including the dining area and lobby. And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art meeting room with video projectors, high definition video screens, and advanced sound technology.</p>
        </div>
 ...
 <article class="players halfheight">
        <img src="images/players/judyDines.jpg">
        <div class="content">
          <h2>Judy Dines</h2>
          <p>Our hotel boasts wireless Internet in every common room, and guest room, including the dining area and lobby. And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art meeting room with video projectors, high definition video screens, and advanced sound technology.</p>
        </div>
 ...
 <article class="players halfheight">
        <img src="images/players/kellyTompkins.jpg">
        <div class="content">
 ...
 <article class="players halfheight">
        <img src="images/players/kennethLaw.jpg">
        <div class="content">
          <h2>Kenneth Law</h2>
          <p>Our hotel boasts wireless Internet in every common room, and guest room, including the dining area and lobby. And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art And, we have a state-of-the-art meeting room with video projectors, high definition video screens, and advanced sound technology.</p>
        </div>
 ...
 <article class="players halfheight">
        <img src="images/players/terrenceWilson.jpg">
        <div class="content">
